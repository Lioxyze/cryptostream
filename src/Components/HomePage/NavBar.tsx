  ...
  return (
    <div>
      <nav className="relative px-4 py-4 flex justify-between items-center bg-[#111F2E]">
        ...
        <a
          className="text-3xl font-bold leading-none relative flex items-center space-x-3 border border-gray-400 rounded-md px-4 py-2"
          href="#"
        >
        ...
        <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2  lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
          ...
          <li>
            <a className="text-sm text-blue-600 font-bold" href="/crypto">
              Buy Crypto
            </a>
          </li>
          <li className="text-gray-300">
